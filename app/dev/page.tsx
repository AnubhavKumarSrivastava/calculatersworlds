...
export const metadata: Metadata = {
  ...
  description: "Browser-first utilities for JSON, Base64, URLs, UUIDs, regex, HTML, CSS, JavaScript and technical workflows.",
  ...
  return (
    <main>
      <section className="container" style={{ padding: "56px 0 30px" }}>
        ...
        <p className="muted" style={{ maxWidth: 780, fontSize: 18 }}>Browser-first utilities for JSON, Base64, URLs, UUIDs, regex, HTML, CSS, JavaScript and technical workflows.</p>
      </section>
