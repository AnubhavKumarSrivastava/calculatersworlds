...
export const metadata: Metadata = {
  title: "File Tools",
  description: "Convert, compress, resize, merge and organize common images and PDF documents.",
  ...
  return (
    <main>
      <section className="container" style={{ padding: "56px 0 30px" }}>
        <span className="hero-badge">📄 File Tools</span>
        <h1 style={{ fontSize: "clamp(40px,6vw,66px)", margin: "16px 0 10px", fontWeight: 950, letterSpacing: "-.05em" }}>
          File Tools
        </h1>
        <p className="muted" style={{ maxWidth: 780, fontSize: 18 }}>Convert, compress, resize, merge and organize common images and PDF documents.</p>
      </section>
