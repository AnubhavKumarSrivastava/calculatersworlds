...
export const metadata: Metadata = {
  ...
  description: "Plan FD, RD, PPF, NPS, EPF, gratuity, HRA, compound interest and inflation with clear financial estimates.",
  ...
  return (
    <main>
      <section className="container" style={{ padding: "56px 0 30px" }}>
        <span className="hero-badge">💰 Finance Calculators</span>
        <h1 style={{ fontSize: "clamp(40px,6vw,66px)", margin: "16px 0 10px", fontWeight: 950, letterSpacing: "-.05em" }}>
          Finance Calculators
        </h1>
        <p className="muted" style={{ maxWidth: 780, fontSize: 18 }}>Plan FD, RD, PPF, NPS, EPF, gratuity, HRA, compound interest and inflation with clear financial estimates.</p>
      </section>
